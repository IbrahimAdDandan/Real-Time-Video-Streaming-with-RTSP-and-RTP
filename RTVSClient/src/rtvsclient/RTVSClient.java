...
public class RTVSClient {
    ...
    //Constructor
    //--------------------------
    public RTVSClient() throws SocketException {
        ...
        tearButton.setBackground(Color.white);
        forward.setBackground(Color.white);
        setupButton.setFont(new Font("arial", 1, 10));
        playButton.setFont(new Font("arial", 1, 10));
        pauseButton.setFont(new Font("arial", 1, 10));
        tearButton.setFont(new Font("arial", 1, 10));
        forward.setFont(new Font("arial", 1, 10));
        //Image display label
        ...
        iconLabel.setBounds(120, 0, 375, 255);
        mainPanel.setBackground(Color.black);
        buttonPanel.setBounds(0, 215, 375, 25);
        f.setLocation(600, 400);
        f.getContentPane().add(mainPanel, BorderLayout.CENTER);
        f.setSize(new Dimension(390, 280));
        f.setFont(new Font("Comic Sans MS", Font.CENTER_BASELINE, 12));
        ...
        buf = new byte[15000];
        RTPsocket = new DatagramSocket(25000);
    }
    ...
    public static void main(String argv[]) throws Exception {
        ...
        RTVSClient theClient = new RTVSClient();
        int RTSP_server_port = 1035;
        String ServerHost = "localhost";
        InetAddress ServerIPAddr = InetAddress.getByName(ServerHost);
        VideoFileName = "E:/1.MJPEG";
